...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen" style={{background: '#FDF6EC'}}>
      {/* Header */}
      <div className="px-4 py-6" style={{background: 'linear-gradient(135deg, #8B0000 0%, #C19A6B 100%)'}}>
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl mt-2" style={{color: '#FDF6EC'}}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        {/* Last Updated */}
        <div className="bg-white rounded-lg p-6 mb-8 border-l-4" style={{borderColor: '#C19A6B'}}>
        ...
        <div className="bg-white rounded-lg p-8 mb-8">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-2xl font-bold" style={{color: '#1C1C1C'}}>Introduction</h2>
          </div>
        ...
        <div className="bg-white rounded-lg p-8 mb-8">
          <div className="flex items-center space-x-3 mb-6">
            <Eye className="w-8 h-8" style={{color: '#C19A6B'}} />
            <h2 className="text-2xl font-bold" style={{color: '#1C1C1C'}}>Information We Collect</h2>
          </div>
        ...
        <div className="bg-white rounded-lg p-8 mb-8">
          <div className="flex items-center space-x-3 mb-6">
            <FileText className="w-8 h-8" style={{color: '#C19A6B'}} />
            <h2 className="text-2xl font-bold" style={{color: '#1C1C1C'}}>How We Use Your Information</h2>
          </div>
        ...
        <div className="bg-white rounded-lg p-8 mb-8">
          <div className="flex items-center space-x-3 mb-6">
            <Lock className="w-8 h-8" style={{color: '#C19A6B'}} />
            <h2 className="text-2xl font-bold" style={{color: '#1C1C1C'}}>Data Security</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            <div className="text-center p-4 border rounded-lg" style={{borderColor: '#C19A6B'}}>
              <div className="w-12 h-12 mx-auto mb-3 rounded-full flex items-center justify-center" 
                   style={{backgroundColor: '#C19A6B'}}>
                <Lock className="w-6 h-6" style={{color: '#1C1C1C'}} />
              </div>
              <h4 className="font-semibold" style={{color: '#1C1C1C'}}>Encryption</h4>
              <p className="text-sm text-gray-600 mt-1">All data transmitted is encrypted using SSL/TLS</p>
            </div>
            <div className="text-center p-4 border rounded-lg" style={{borderColor: '#3B7A57'}}>
              <div className="w-12 h-12 mx-auto mb-3 rounded-full flex items-center justify-center" 
                   style={{backgroundColor: '#3B7A57'}}>
                <Shield className="w-6 h-6" style={{color: 'white'}} />
              </div>
              <h4 className="font-semibold" style={{color: '#1C1C1C'}}>Access Control</h4>
              <p className="text-sm text-gray-600 mt-1">Limited access to authorized personnel only</p>
            </div>
            <div className="text-center p-4 border rounded-lg" style={{borderColor: '#1C1C1C'}}>
              <div className="w-12 h-12 mx-auto mb-3 rounded-full flex items-center justify-center" 
                   style={{backgroundColor: '#1C1C1C'}}>
                <FileText className="w-6 h-6 text-white" />
              </div>
              <h4 className="font-semibold" style={{color: '#1C1C1C'}}>Regular Audits</h4>
        ...
        {/* Your Rights */}
        <div className="bg-white rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold mb-6" style={{color: '#1C1C1C'}}>Your Rights</h2>
