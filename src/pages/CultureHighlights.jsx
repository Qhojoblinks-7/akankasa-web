...
              return (
                <div className={`w-12 h-12 rounded-lg flex items-center justify-center mr-4`} style={{backgroundColor: sections.find(s => s.id === activeSection).color}}>
...
              className="bg-white text-yellow-500 px-6 py-3 rounded-lg font-semibold hover:text-gray-100 hover:bg-gray-500 transition-colors"
            >
              Contribute Content
            </button>
          </div>
