...
const AdminFolkStories = () => {
  ...
  const [form, setForm] = useState({
    ...
    narrator: '', region: '', is_published: true
  });
  ...
  const openCreate = () => {
    setEditingId(null);
    setForm({ title: '', description: '', thumbnail: '', category: '', language: 'Twi', duration: '', type: 'audio', audio_url: '', video_url: '', transcript: '', narrator: '', region: '', is_published: true });
    setModalOpen(true);
  };
