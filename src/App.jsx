            ...
            <div className="min-h-screen bg-gray-50">
              ...
              <main id="main-content" className="flex-1">
                <Routes>
                  ...
                  <Route path="/community/members" element={<Community initialTab="members" />} />
                  <Route path="/community/events" element={<EventsPage />} />
                  <Route path="/community/events/:eventId/register" element={<EventRegistration />} />
                  <Route path="/community/events/new" element={<ProtectedRoute><EventCreation /></ProtectedRoute>} />
                  ...
                  <Route path="/contribute-content" element={<ProtectedRoute><PublicContributions /></ProtectedRoute>} />
                  <Route path="/community/join" element={<CommunityJoin />} />
                  <Route path="/community/new-post" element={<ProtectedRoute><CommunityNewPost /></ProtectedRoute>} />
                  ...
                  {featureFlags.showResearch && (
                    <>
                      <Route path="/research/new-discussion" element={<ProtectedRoute><ResearchNewDiscussion /></ProtectedRoute>} />
                      <Route path="/research/propose-project" element={<ProtectedRoute><ResearchProposeProject /></ProtectedRoute>} />
                    </>
                  )}
