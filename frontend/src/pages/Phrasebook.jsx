    ...
    <div className="min-h-screen bg-gray-50">
      <div className="text-white" style={{background: 'linear-gradient(135deg, #564c38 0%, #695e46 100%)'}}>
        <div className="w-full sm:w-[80%] md:w-[75%] lg:w-[94%] mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-2">Akan Phrasebook</h1>
          <p className="text-base opacity-90 max-w-3xl">Common phrases and expressions for everyday conversations</p>
        </div>
      </div>
      ...
      <div className="w-full sm:w-[80%] md:w-[75%] lg:w-[94%] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
             {phrases.map((phrase) => (
               <div key={phrase.id} className="bg-white rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow">
                 <div className="flex items-start justify-between mb-3">
                   <div>
                     <h3 className="text-base font-bold text-gray-900">{phrase.akan}</h3>
